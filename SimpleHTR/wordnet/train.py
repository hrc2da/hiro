...
from dataset import DatasetIAM, DatasetIAMSplit, DatasetHIRO, DatasetHIROSplit
...
def main():
    ...
    dataset = DatasetHIRO(args.data_dir, net.input_size, net.output_size, caching=args.caching, randomize=True, seed=10)
    dataset_train = DatasetHIROSplit(dataset, 2 * args.batch_size, len(dataset))
    dataset_val = DatasetHIROSplit(dataset, 0, 2 * args.batch_size)

    # loaders
    loader_train = DataLoaderIAM(dataset_train, args.batch_size, net.input_size, net.output_size,device=device)
    loader_val = DataLoaderIAM(dataset_val, args.batch_size, net.input_size, net.output_size, device=device)
